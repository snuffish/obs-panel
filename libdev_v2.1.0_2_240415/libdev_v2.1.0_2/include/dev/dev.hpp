...
public:
     ...
     * @category  tiny2.
     * @param  [in] enabled   1->Enable the auto track.
     *                        0->Disable the auto track.
     * @return  RM_RET_OK for success, RM_RET_ERR for failed.
     */
    int32_t aiSetZoneTrackGimbalEnabledR(int32_t enabled);
     ...
     * @category  tiny2.
     * @param  [int] enabled  0->Disabled auto-select function
     *                        1->Enabled auto-select function
     * @return  RM_RET_OK for success, RM_RET_ERR for failed.
     */
    int32_t aiSetLimitedZoneTrackAutoSelectR(uint8_t enabled);

    /**
     * @brief  Get whether to enable automatic target selection for region-limited tracking.
     * @category  tiny2.
     * @param  [out] enabled  0->Disabled auto-select function
     *                        1->Enabled auto-select function
     * @return  RM_RET_OK for success, RM_RET_ERR for failed.
     */
    int32_t aiGetLimitedZoneTrackAutoSelectR(uint8_t &enabled);
     ...
     * @category  tiny2.
     * @param  [in] enabled   0->Disabled the limited track region function
     *                        1->Enabled the limited track region function
     * @return  RM_RET_OK for success, RM_RET_ERR for failed.
     */
    int32_t aiSetLimitedZoneTrackEnabledR(uint8_t enabled);

    /**
     * @brief  Get whether to enable the limited track region function.
     * @category  tiny2.
     * @param  [out] enabled  0->Disabled the limited track region function
     *                        1->Enabled the limited track region function
     * @return  RM_RET_OK for success, RM_RET_ERR for failed.
     */
    int32_t aiGetLimitedZoneTrackEnabledR(uint8_t &enabled);
