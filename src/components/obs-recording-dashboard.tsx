...
import { Circle, Pause, Square, Folder, HardDrive, Clock, Film } from "lucide-react"
      ...
      <Card>
        ...
        <CardContent className="flex justify-between items-center">
          <div className="flex items-center space-x-2">
            <Badge variant={isRecording ? (isPaused ? "" : "destructive") : "outline"}>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-neutral-500 dark:text-neutral-400">{outputPath}</span>
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="separate-audio">Record separate audio tracks</Label>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Select value={encoderSettings.videoEncoder} onValueChange={(value) => setEncoderSettings({...encoderSettings, videoEncoder: value})}>
            ...
            <div className="space-y-2">
              ...
              <Select value={encoderSettings.audioEncoder} onValueChange={(value) => setEncoderSettings({...encoderSettings, audioEncoder: value})}>
            ...
            <div className="space-y-2">
              ...
              <Select value={encoderSettings.quality} onValueChange={(value) => setEncoderSettings({...encoderSettings, quality: value})}>
