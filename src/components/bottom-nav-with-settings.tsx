...
export function BottomNavWithSettingsComponent() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-neutral-200 p-2 dark:bg-neutral-950 dark:border-neutral-800">
          ...
          <DialogContent className="sm:max-w-[425px]">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input id="server" defaultValue="obs-websocket.local" className="col-span-3" />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Switch id="auto-connect" defaultChecked className="col-span-3" />
              </div>
            </div>
